...
public class BAppSettings {
    ...
    private int room_lady_count = 6;  //房间参加的人数
    ...
    public int getRoom_lady_count() {
        return room_lady_count;
    }

    public void setRoom_lady_count(int room_lady_count) {
        this.room_lady_count = room_lady_count;
    }
}
